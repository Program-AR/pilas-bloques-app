...
export const getChapter = (id: string): Chapter => {
  const groupData: RawChapterData = rawChapterData.find(
...
export const chapterIncludesChallenge = (
  chapter: Chapter,
  challenge: Challenge
): boolean => {
  return chapter.groups.some((group) =>
    groupIncludesChallenge(group, challenge)
  )
}
...
export const rawChapterData: RawChapterData[] = [
  {
    id: "Capítulo 3",
    groupIds: [
      "manual1cPrimaria3.1.2",
      "manual1cPrimaria3.1.3",
      "manual1cPrimaria3.1.4",
      "manual1cPrimaria3.2.2",
      "manual1cPrimaria3.2.3",
      "manual1cPrimaria3.I",
    ],
  },
  {
    id: "Capítulo 4",
    groupIds: [
      "manual1cPrimaria4.1.3",
      "manual1cPrimaria4.1.4",
      "manual1cPrimaria4.2.3",
      "manual1cPrimaria4.I",
    ],
    expectations: {
  ...
  },
  {
    id: "Capítulo 5",
    groupIds: [
      "manual1cPrimaria5.1.3",
      "manual1cPrimaria5.1.4",
      "manual1cPrimaria5.2.1",
      "manual1cPrimaria5.I",
      "manual1cPrimariaOtros",
    ],
    expectations: {
  ...
  },
  {
    ...
    groupIds: [
      ...
      "ElGatoEnLaCalle",
      "NoMeCansoDeSaltar",
      "ElMarcianoEnElDesierto",
      "TitoEnciendeLuces",
      "ElAlienYLasTuercas",
      "ElRecolectorDeEstrellas",
      "MariaLaComeSandias",
      "AlimentandoALosPeces",
      "InstalandoJuegos",
      "LaGranAventuraDelMarEncantado",
      "ReparandoLaNave",
    ],
    expectations: {
      simpleRepetition: true,
  ...
  },
  {
    ...
    groupIds: [
      ...
      "TitoRecargado",
      "LaberintoLargo",
      "ElPasilloCurvoDeSandias",
      "ElFestinFrutal",
      "RecolectorDeGalaxias",
      "ElDesiertoMultiFrutal",
    ],
  },
  {
  ...
  },
  {
    ...
    groupIds: [
      ...
      "LaFiestaDeDracula",
      "SalvandoLaNavidad",
      "PrendiendoLasCompusParametrizado",
      "TitoCuadrado",
      "ElCangrejoAguafiestas",
      "PrendiendoLasFogatas",
      "DibujoLibre",
    ],
    expectations: {
      simpleRepetition: true,
