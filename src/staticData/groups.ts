...
export const groupIncludesChallenge = (
  group: Group,
  challenge: Challenge
): boolean => {
  return group.challenges.some(
    (otherChallenge) => otherChallenge.id === challenge.id
  )
}
...
const rawGroupData: RawGroupData[] = [
  ...
  },
  {
    ...
    challengeIds: [
      2021001, 2021002, 2021003, 2021004, 2021005, 2021006, 2021007, 2021008,
    ],
  },
  {
    id: "tecnopolis2021ConLita",
    challengeIds: [
      2021101, 2021102, 2021103, 2021104, 2021105, 2021106, 2021107, 2021108,
    ],
  },
  {
    id: "tecnopolis2021ConCoty",
    challengeIds: [
      2021201, 2021202, 2021203, 2021204, 2021205, 2021206, 2021207,
    ],
  },
  {
    id: "tecnopolis2021ConToto",
    challengeIds: [
      2021301, 2021302, 2021303, 2021304, 2021305, 2021306, 2021307, 2021308,
      2021309,
    ],
  },
]
