...
export const getBook = (id: number): Book => {
  const bookData: RawBookData | undefined = rawBooksData.find(
...
export const bookIncludesChallenge = (
  book: Book,
  challenge: Challenge
): boolean => {
...
const rawBooksData: RawBookData[] = [
  ...
  },
  {
    id: 100,
    chapterIds: [
      "Tecnopolis 2021 Ejercicio Modelo",
      "Tecnopolis 2021 Con Duba",
      "Tecnopolis 2021 Con Lita",
      "Tecnopolis 2021 Con Coty",
      "Tecnopolis 2021 Con Toto",
    ],
    simpleReadMode: true,
  },
]
