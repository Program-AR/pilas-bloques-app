...
// Fuente: https://github.com/Program-AR/pilas-bloques-ember/blob/develop/tests/integration/desafios/BuscandoLasEstrellas-test.js
      ...
      <xml xmlns="http://www.w3.org/1999/xhtml">
         <block type="al_empezar_a_ejecutar" id="2" deletable="false" movable="false" editable="false" x="0" y="0">
            <statement name="program">
               <block type="Repetir" id="3" inline="true">
                  <value name="count">
                  ...
                  <statement name="block">
                     <block type="MoverTelescopio" id="4b" />
                  </statement>
                  <next>
                     <block type="SiguienteTelescopio" id="5">
                        <next>
                           <block type="Repetir" id="6" inline="true">
                              <value name="count">
                              ...
                              <statement name="block">
                                 <block type="MoverTelescopio" id="7b" />
                              </statement>
                              <next>
                                 <block type="SiguienteTelescopio" id="8">
                                    <next>
                                       <block type="Repetir" id="9" inline="true">
                                          <value name="count">
                                          ...
                                          <statement name="block">
                                             <block type="MoverTelescopio" id="10b" />
                                          </statement>
                                          <next>
